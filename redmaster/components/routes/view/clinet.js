...
export default function ClintLogin() {
      ...
      <View style={style.Title}>
        ...
        <TouchableOpacity style={style.button2}
            onPress={( ) => navigation.navigate('Company')
                ...
                <Feather name="briefcase" size={35} color={"#242424"} />
        </TouchableOpacity>
      </View>
      <Animatable.View  animation="fadeInUp" style={style.form}>
        <TextInput style={style.input} placeholder="Digite seu E-mail" placeholderTextColor="#ffffff" />
        <TextInput style={style.input}  placeholder="Digite seu Usuário" placeholderTextColor="#ffffff" />
